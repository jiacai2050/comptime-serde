...
REPO="jiacai2050/comptime-serde"
BINARY_NAME="serde-gen"
...
usage() {
    ...
    echo "Options:"
    echo "  -v, --version <ver>      Release version (e.g. v0.1.0), default is latest"
...
if [ -z "$VERSION" ]; then
    ...
    echo "  1. Specify a version explicitly: $0 --version v0.1.0"
